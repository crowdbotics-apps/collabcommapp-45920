"""
Django settings for collabcommapp_45920 project.
...
ROOT_URLCONF = 'collabcommapp_45920.urls'
...
WSGI_APPLICATION = 'collabcommapp_45920.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "collabcommapp_45920 API",
    "DESCRIPTION": "API documentation for collabcommapp_45920 App",
    "VERSION": "v1",
}
